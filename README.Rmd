...
Download a PMC `xml_document` using the [europepmc] package.
...
package to extract any matching regular expression.
...
See the [vignette]  for more details on the `tidypmc` package.
